...
def build_commands(manager: str | None, names: dict) -> dict:
    ...
    commands = {
        ...
        "ls": Command(
            run=lambda arg: (["ls", "--color=auto"] + (shlex.split(arg) if arg else [])) if not IS_WINDOWS else ([sys.executable, "-m", "hopit.ls"] + (shlex.split(arg) if arg else [])),
            desc="List directory contents: ls [options] [path]",
            needs_arg=False,
            mode="stream" if not IS_WINDOWS else "capture",
            arg_completions=names["path"],
            arg_completion_kind="path",
            is_universal=False,
            use_panel=False,
        ...
        "cp": Command(
            run=lambda arg: (["cp"] + (shlex.split(arg) if arg else [])) if not IS_WINDOWS else ([sys.executable, "-m", "hopit.cp"] + (shlex.split(arg) if arg else [])),
        ...
        "mv": Command(
            run=lambda arg: (["mv"] + (shlex.split(arg) if arg else [])) if not IS_WINDOWS else ([sys.executable, "-m", "hopit.mv"] + (shlex.split(arg) if arg else [])),
        ...
        "rm": Command(
            run=lambda arg: (["rm"] + (shlex.split(arg) if arg else [])) if not IS_WINDOWS else ([sys.executable, "-m", "hopit.rm"] + (shlex.split(arg) if arg else [])),
        ...
        "mkdir": Command(
            run=lambda arg: (["mkdir"] + (shlex.split(arg) if arg else [])) if not IS_WINDOWS else ([sys.executable, "-m", "hopit.mkdir"] + (shlex.split(arg) if arg else [])),
        ...
        "touch": Command(
            run=lambda arg: (["touch"] + (shlex.split(arg) if arg else [])) if not IS_WINDOWS else ([sys.executable, "-m", "hopit.touch"] + (shlex.split(arg) if arg else [])),
        ...
        "cat": Command(
            run=lambda arg: (["cat"] + (shlex.split(arg) if arg else [])) if not IS_WINDOWS else ([sys.executable, "-m", "hopit.cat"] + (shlex.split(arg) if arg else [])),
        ...
        "head": Command(
            run=lambda arg: (["head"] + (shlex.split(arg) if arg else [])) if not IS_WINDOWS else ([sys.executable, "-m", "hopit.head"] + (shlex.split(arg) if arg else [])),
        ...
        "tail": Command(
            run=lambda arg: (["tail"] + (shlex.split(arg) if arg else [])) if not IS_WINDOWS else ([sys.executable, "-m", "hopit.tail"] + (shlex.split(arg) if arg else [])),
        ...
        "less": Command(
            run=lambda arg: (["less"] + (shlex.split(arg) if arg else [])) if not IS_WINDOWS else ([sys.executable, "-m", "hopit.less"] + (shlex.split(arg) if arg else [])),
        ...
        "find": Command(
            run=lambda arg: (["find"] + (shlex.split(arg) if arg else [])) if not IS_WINDOWS else ([sys.executable, "-m", "hopit.find"] + (shlex.split(arg) if arg else [])),
        ...
        "grep": Command(
            run=lambda arg: (["grep", "--color=auto"] + (shlex.split(arg) if arg else [])) if not IS_WINDOWS else ([sys.executable, "-m", "hopit.grep"] + (shlex.split(arg) if arg else [])),
